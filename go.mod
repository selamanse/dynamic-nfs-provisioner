...
replace github.com/openebs/maya => ./third_party/maya

replace sigs.k8s.io/sig-storage-lib-external-provisioner/v7 => ./third_party/sig-storage-lib-external-provisioner-v7
