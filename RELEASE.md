...
Once the release is triggered, Github Actions release workflow has to be monitored. Once the release workflow is passed images are pushed to GHCR. Images can be verified by going through GHCR. Also the images shouldn't have any high-level vulnerabilities.

Images for the different components are published at the following location:

- Dynamic NFS PV Provisioner <br />
    https://github.com/selamanse/dynamic-nfs-provisioner/pkgs/container/dynamic-nfs-provisioner <br />
